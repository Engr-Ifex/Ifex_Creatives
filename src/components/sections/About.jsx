      ...
      <div className="mx-auto grid max-w-5xl grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          <div className="relative">
            <div
              className="
                ...
                light:border-black/10 light:bg-white/70
                light:shadow-[0_0_25px_rgba(0,0,0,0.08)]
              "
            >
              <img
                src={aboutImg}
            ...
            <div
              className="
                pointer-events-none absolute -bottom-10 left-1/2
                h-32 w-[80%] max-w-[420px] -translate-x-1/2 rounded-full
                bg-[#5CBF0D]/30 blur-[80px]
        ...
        <div className="flex flex-col gap-6">
          ...
          <FadeInSection>
            <div
              className="
                inline-flex w-fit items-center gap-2 rounded-full px-4 py-2 text-xs backdrop-blur-xl
          ...
          <FadeInSection delay={0.3}>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3 text-sm text-white/80 light:text-black/80">
          ...
          <FadeInSection delay={0.4}>
            <div className="mt-4 flex flex-col items-start gap-6 sm:flex-row sm:items-center">
              ...
              <a href="#projects">
                <button
                  className="
                    ...
                    hover:scale-[1.03] hover:shadow-[0_0_25px_rgba(92,191,13,0.5)]
                  "
                >
                  View My Work
                </button>
              ...
              {/* Social proof */}
              <div className="flex flex-col text-sm text-white/60 light:text-black/60">
