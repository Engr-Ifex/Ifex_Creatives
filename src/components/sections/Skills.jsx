...
const Skills = () => {
  return (
    ...
    >
      ...
      {/* <div
        className="
          absolute top-0 left-1/2 h-64 w-[500px] -translate-x-1/2 rounded-full
          bg-[#5CBF0D]/10 blur-[120px]
          light:bg-[#5CBF0D]/20
        "
      /> */}
          ...
          {skillsData.map((category, index) => {
            ...
            return (
              <FadeInSection key={index} delay={index * 0.1}>
                <div
                  className="
                    group lg:h-[250px] cursor-pointer rounded-2xl p-6
                    transition-all duration-300 ease-out

                    border border-white/10 bg-[#0a0a0a]
                    hover:-translate-y-1 hover:border-[#5CBF0D]/30
                    hover:shadow-[0_0_25px_rgba(92,191,13,0.12)]

                    light:bg-white light:border-black/10
                    light:hover:border-[#5CBF0D]/40
                    light:hover:shadow-[0_10px_30px_rgba(0,0,0,0.08)]
                  "
                >
                  {/* Header */}
                  ...
                  {/* Description */}
                  <p className="mb-4 text-sm text-white/60 light:text-black/60">
                      ...
                      return (
                        <span
                          ...
                          className="
                            ...
                            hover:border-[#5CBF0D]/30 hover:text-[#5CBF0D]

                            light:bg-black/[0.04] light:border-black/10 light:text-black/70
                            light:hover:bg-[#5CBF0D]/10 light:hover:text-[#5CBF0D]
                          "
                        >
